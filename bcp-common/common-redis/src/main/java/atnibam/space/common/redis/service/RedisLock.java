package atnibam.space.common.redis.service;
...
public class RedisLock {
    ...
    public static boolean lock(RLock lock, Supplier<Boolean> conditions) {
        return lock(lock, CacheConstants.NO_TRY_COUNT, CacheConstants.NO_TRY_SLEEP_TIME, conditions);
    }
    ...
    public static boolean lock(RLock lock, int tryCount, long sleepTime) {
        return lock(lock, CacheConstants.DEF_WAIT_TIME, CacheConstants.DEF_EXPIRE_TIME, tryCount, sleepTime,() -> true);
    }
    ...
    public static boolean lock(RLock lock, int tryCount, long sleepTime, Supplier<Boolean> conditions) {
        return lock(lock, CacheConstants.DEF_WAIT_TIME, CacheConstants.DEF_EXPIRE_TIME, tryCount, sleepTime, conditions);
    }

...
import space.atnibam.transaction.enums.WxRefundStatus;
...
import space.atnibam.transaction.mapper.RefundInfoMapper;
...
public class RefundInfoServiceImpl extends ServiceImpl<RefundInfoMapper, RefundInfo>
    ...
    public void updateRefundForAliPay(String refundNo, String content, String refundStatus) {
        ...
        // 根据退款单编号构造查询条件
        QueryWrapper<RefundInfo> queryWrapper = new QueryWrapper<>();
        queryWrapper.eq(AliPayConstant.REFUND_NO, refundNo);

package space.atnibam.transaction.utils;
...
public class WxPayUtils {
    ...
    public static Map<String, String> sendRequest(CloseableHttpClient wxPayClient, String url, Object requestData, String logInfo) throws IOException {
        ...
        StringEntity entity = new StringEntity(jsonParams, WxPayConstant.UTF8);
        entity.setContentType(WxPayConstant.APP_JSON);

        httpPost.setEntity(entity);
        httpPost.setHeader(WxPayConstant.ACCEPT, WxPayConstant.APP_JSON);

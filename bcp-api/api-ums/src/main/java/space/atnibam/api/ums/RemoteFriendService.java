...
import space.atnibam.api.ums.interceptor.UmsFeignInterceptor;
 ...
 **/
@FeignClient(value = "modules-ums", contextId = "friend", url = "http://local.atnibam.space:9028", configuration = UmsFeignInterceptor.class)
